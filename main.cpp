...
#include <fstream> // Necessary for std::clamp
#include <glm/glm.hpp>
#include <array>
  ...
  private:
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
      ...
      vkCmdBeginRenderPass(commandBuffer, &renderPassInfo, VK_SUBPASS_CONTENTS_INLINE);
        ...
        /* drawing from vertex buffer */
        //vkCmdDraw(commandBuffer, static_cast<uint32_t>(vertices.size()), 1, 0, 0);

        /* drawing from index buffer */
    ...
    void createRenderPass() {
      ...
      VkAttachmentReference colorAttachmentRef{};
        /* the index of the attachment is referenced in the shader.frag */
    ...
    void createLogicalDevice() {
      ...
      std::set<uint32_t> uniqueQueuFamilies = { indices.graphicsFamily.value(), indices.presentFamily.value() };
